...
public class TableConfig {
    ...
    public static void getTable(int id, String name, double price, int quality, Date importDate) {
        ...
        table.addCell(String.valueOf(importDate), new CellStyle(CellStyle.HorizontalAlign.CENTER));
